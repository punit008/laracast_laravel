<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <x-dropdown>
                <x-slot name="trigger">
                    <buttton class="flex-1 appearance-none bg-transparent py-2 pl-3 pr-9 text-sm font-semibold w-32">{{ isset($currentCategory) ? $currentCategory->name : 'Categories'}}</buttton>
                </x-slot>
